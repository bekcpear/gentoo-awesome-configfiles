...
RPROMPT="%{$fg_bold[white]%}%F{218}%w %{$reset_color%}%*%K{00}%F{15} %K{15}%F{00} %h %f%k"
...
%{$reset_color%} %F{00}%K{218}%F{218}%K{197} %{$fg_bold[white]%}%# %{$reset_color%}%K{00}%F{197}%{$reset_color%} %f%k"
